...
require (
	github.com/Lagrange-Labs/client-cli v1.0.1
...
require (
	github.com/Lagrange-Labs/lagrange-node v1.0.1 // indirect
	github.com/Layr-Labs/eigenlayer-contracts v0.4.1-holesky-pepe.0.20240813143901-00fc4b95e9c1 // indirect
