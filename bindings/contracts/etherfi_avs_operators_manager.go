...
// RegisterOperator is a paid mutator transaction binding the contract method 0x0878619f.
//
// Solidity: function registerOperator(uint256 _id, address _avsRegistryCoordinator, (bytes,bytes32,uint256) _operatorSignature) returns()
func (_EtherfiAVSOperatorsManager *EtherfiAVSOperatorsManagerTransactor) RegisterOperator(opts *bind.TransactOpts, _id *big.Int, _avsRegistryCoordinator common.Address, _operatorSignature ISignatureUtilsSignatureWithSaltAndExpiry) (*types.Transaction, error) {
	return _EtherfiAVSOperatorsManager.contract.Transact(opts, "registerOperator", _id, _avsRegistryCoordinator, _operatorSignature)
}

// RegisterOperator is a paid mutator transaction binding the contract method 0x0878619f.
//
// Solidity: function registerOperator(uint256 _id, address _avsRegistryCoordinator, (bytes,bytes32,uint256) _operatorSignature) returns()
func (_EtherfiAVSOperatorsManager *EtherfiAVSOperatorsManagerSession) RegisterOperator(_id *big.Int, _avsRegistryCoordinator common.Address, _operatorSignature ISignatureUtilsSignatureWithSaltAndExpiry) (*types.Transaction, error) {
	return _EtherfiAVSOperatorsManager.Contract.RegisterOperator(&_EtherfiAVSOperatorsManager.TransactOpts, _id, _avsRegistryCoordinator, _operatorSignature)
}

// RegisterOperator is a paid mutator transaction binding the contract method 0x0878619f.
//
// Solidity: function registerOperator(uint256 _id, address _avsRegistryCoordinator, (bytes,bytes32,uint256) _operatorSignature) returns()
func (_EtherfiAVSOperatorsManager *EtherfiAVSOperatorsManagerTransactorSession) RegisterOperator(_id *big.Int, _avsRegistryCoordinator common.Address, _operatorSignature ISignatureUtilsSignatureWithSaltAndExpiry) (*types.Transaction, error) {
	return _EtherfiAVSOperatorsManager.Contract.RegisterOperator(&_EtherfiAVSOperatorsManager.TransactOpts, _id, _avsRegistryCoordinator, _operatorSignature)
}

// RegisterOperatorWithChurn is a paid mutator transaction binding the contract method 0x658167d6.
//
// Solidity: function registerOperatorWithChurn(uint256 _id, address _avsRegistryCoordinator, (uint8,address)[] _operatorKickParams, (bytes,bytes32,uint256) _churnApproverSignature, (bytes,bytes32,uint256) _operatorSignature) returns()
func (_EtherfiAVSOperatorsManager *EtherfiAVSOperatorsManagerTransactor) RegisterOperatorWithChurn(opts *bind.TransactOpts, _id *big.Int, _avsRegistryCoordinator common.Address, _operatorKickParams []IRegistryCoordinatorOperatorKickParam, _churnApproverSignature ISignatureUtilsSignatureWithSaltAndExpiry, _operatorSignature ISignatureUtilsSignatureWithSaltAndExpiry) (*types.Transaction, error) {
	return _EtherfiAVSOperatorsManager.contract.Transact(opts, "registerOperatorWithChurn", _id, _avsRegistryCoordinator, _operatorKickParams, _churnApproverSignature, _operatorSignature)
}
...
func (_EtherfiAVSOperatorsManager *EtherfiAVSOperatorsManagerSession) RegisterOperatorWithChurn(_id *big.Int, _avsRegistryCoordinator common.Address, _operatorKickParams []IRegistryCoordinatorOperatorKickParam, _churnApproverSignature ISignatureUtilsSignatureWithSaltAndExpiry, _operatorSignature ISignatureUtilsSignatureWithSaltAndExpiry) (*types.Transaction, error) {
	return _EtherfiAVSOperatorsManager.Contract.RegisterOperatorWithChurn(&_EtherfiAVSOperatorsManager.TransactOpts, _id, _avsRegistryCoordinator, _operatorKickParams, _churnApproverSignature, _operatorSignature)
}
